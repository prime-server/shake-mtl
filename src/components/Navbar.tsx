    ...
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="nav-inner">
        ...
        <div className="nav-right">
          ...
          <Link to="/account" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', width: 40, height: 40, color: 'rgba(255,255,255,0.7)' }} aria-label="My account">
